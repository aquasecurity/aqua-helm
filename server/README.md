...
| `serviceAccount.name`                               | Mention the existing service-account name to overwrite the default serviceAccount name. The default is {{ .Release.Namespace }}-sa                                                                 | `aqua-sa`                                             |                                                                                                  |
...
| `global.db.image.tag`                               | The image tag to use.                                                                                                                                                                              | `10`                                     | `NO`                                                                                             |
...
| `global.db.upgradeJobAnnotations`                          | DB Upgrade Job Annotations                                                                                                                                                                         | `{}`                                         | `NO`                                                                                             |
...
| `gateway.image.tag`                                 | The image tag to use.                                                                                                                                                                              | `10`                                     | `NO`                                                                                             |
...
| `gateway.serviceAccount.attachImagePullSecret`                | Attach image pull secret to created service account                                                                                                                                                    | `true`                                           | 
...
| `web.image.tag`                                     | The image tag to use.                                                                                                                                                                              | `10`                                     | `NO`                                                                                             |
