...
| `serviceAccount.name`                               | Mention the existing service-account name to overwrite the default serviceAccount name. The default is {{ .Release.Namespace }}-sa                                                                 | `{{ .Release.Namespace }}-sa`                                             |                                                                                                  |
| `serviceAccount.attachImagePullSecret`                               | Attach image pull secret to created service account                                                                 |                                              |                                                                                                  |
