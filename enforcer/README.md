...
`global.gateway.address` | Gateway host address.  For Saas use the hostname containing `-gw` from your onboarding email                                                                                                               | `aqua-gateway-svc`                         | `YES`
`global.gateway.port` | Gateway host port. For Saas use port 443                                                                                                                  | `8443`                                     | `YES`
