...
## Configuration for KubeEnforcer with cert-manager
   ...
   ```shell
   helm upgrade --install --version "2022.4.46" --namespace aqua --values - kube-enforcer aqua-helm/kube-enforcer << EOF
   ...
   certsSecret:
     create: true
     name: aqua-kube-enforcer-certs
...
| `kubeEnforcerAdvance.envoy.image.tag` | envoy image tag for KE advance deployment                                                                                                                                                                                                            | `2022.4.46`                                    | `Yes`                                                                                            |
