...
## Configuration for KubeEnforcer with cert-manager
   ...
   ```shell
   helm upgrade --install --version "10" --namespace aqua --values - kube-enforcer aqua-helm/kube-enforcer << EOF
   ...
   certsSecret:
     create: true
     name: aqua-kube-enforcer-certs
...
| `image.tag`                                                  | Kube-enforcer image tag to use.                                                                                                                                                                                                                      | `10`                                 | `Yes`                                                                                            |
...
| `microEnforcerImage.tag`                                     | MicroEnforcer docker image tag                                                                                                                                                                                                                       | `10`                                 | `YES`                                                                                            |
...
| `kubeEnforcerAdvance.envoy.image.tag`                        | Envoy image tag for KE advance deployment                                                                                                                                                                                                            | `10`                                 | `Yes`                                                                                            |
