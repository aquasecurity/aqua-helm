...
|-------------------------------------|---|----------------------|
| [Server](server/)                   | Deploys the Console, Database components; optionally deploys Envoy component | 6.5.10               |
| [Enforcer](enforcer/)               | Deploys the Aqua Enforcer daemonset | 6.5.6                |
...
aqua-helm/server                    6.5.10               6.5                 A Helm chart for the Aqua Console components
