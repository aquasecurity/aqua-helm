...
|-------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|
| [Server](server/)                   | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component                                                                     | 2022.4.14            |
| [Enforcer](enforcer/)               | Deploys the Aqua Enforcer daemonset                                                                                                                           | 2022.4.12            |
| [Scanner](scanner/)                 | Deploys the Aqua Scanner deployment                                                                                                                           | 2022.4.3             |
| [KubeEnforcer](kube-enforcer/)      | Deploys Aqua KubeEnforcer                                                                                                                                     | 2022.4.22            |
...
aqua-helm/kube-enforcer         2022.4.22       2022.4          A Helm chart for the Aqua KubeEnforcer Starboard
...
aqua-helm/server                2022.4.14       2022.4          A Helm chart for the Aqua Console components
