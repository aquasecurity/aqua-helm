...
|-|-|-|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 6.5.2 |
...
| [Gateway](gateway)| Deploys the Aqua Standalone Gateway | 6.5.2 |
...
aqua-helm/server                    6.5.2               6.5                 A Helm chart for the Aqua Console components
