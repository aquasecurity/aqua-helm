...
|---|---|----------------------|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 2022.4.2             |
...
| [KubeEnforcer](kube-enforcer/)| Deploys Aqua KubeEnforcer | 2022.4.3             |
| [Gateway](gateway)| Deploys the Aqua Standalone Gateway | 2022.4.3             |
...
aqua-helm/gateway               2022.4.3        2022.4          A Helm chart for the Aqua Gateway
aqua-helm/kube-enforcer         2022.4.3        2022.4          A Helm chart for the Aqua KubeEnforcer Starboard
aqua-helm/scanner               2022.4.1        2022.4          A Helm chart for the Aqua Scanner CLI component
aqua-helm/server                2022.4.2        2022.4          A Helm chart for the Aqua Console components
