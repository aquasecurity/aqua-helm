...
|-|-|-|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 6.5.1 |
| [Enforcer](enforcer/) | Deploys the Aqua Enforcer daemonset | 6.5.1 |
| [Scanner](scanner/)  | Deploys the Aqua Scanner deployment | 6.5.1 |
| [KubeEnforcer](kube-enforcer/)| Deploys Aqua KubeEnforcer | 6.5.1 |
| [Gateway](gateway)| Deploys the Aqua Standalone Gateway | 6.5.1 |
...
| [Cloud Connector](cloud-connector/) | Deploys the Aqua Cloud Connector | 6.5.1 |
| [QuickStart](aqua-quickstart/ )| Not for production use (see [below](#quick-start-deployment-not-for-production-purposes)). Deploys the Console, Database, Gateway and KubeEnforcer components | 6.5.1 |
...
aqua-helm/scanner                   6.5.1               6.5                 A Helm chart for the Aqua Scanner CLI component
aqua-helm/server                    6.5.1               6.5                 A Helm chart for the Aqua Console components
aqua-helm/kube-enforcer             6.5.1               6.5                 A Helm chart for the Aqua KubeEnforcer
aqua-helm/gateway                   6.5.1               6.5                 A Helm chart for the Aqua Gateway
...
aqua-helm/cloud-connector           6.5.1               6.5                 A Helm chart for Aqua Cloud-Connector
```
