...
|---|---|----------------------|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 6.5.19               |
| [Enforcer](enforcer/) | Deploys the Aqua Enforcer daemonset | 6.5.15               |
| [Scanner](scanner/)  | Deploys the Aqua Scanner deployment | 6.5.10               |
| [KubeEnforcer](kube-enforcer/)| Deploys Aqua KubeEnforcer | 6.5.16               |
| [Gateway](gateway)| Deploys the Aqua Standalone Gateway | 6.5.11               |
...
aqua-helm/gateway               6.5.11          6.5             A Helm chart for the Aqua Gateway               
aqua-helm/kube-enforcer         6.5.16          6.5             A Helm chart for the Aqua KubeEnforcer Starboard
aqua-helm/scanner               6.5.10          6.5             A Helm chart for the Aqua Scanner CLI component
aqua-helm/server                6.5.19          6.5             A Helm chart for the Aqua Console components
