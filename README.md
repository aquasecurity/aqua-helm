...
|---|---|---|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 6.5.11 |
| [Enforcer](enforcer/) | Deploys the Aqua Enforcer daemonset | 6.5.5 |
| [Scanner](scanner/)  | Deploys the Aqua Scanner deployment | 6.5.3 |
| [KubeEnforcer](kube-enforcer/)| Deploys Aqua KubeEnforcer | 6.5.5 |
| [Gateway](gateway)| Deploys the Aqua Standalone Gateway | 6.5.6 |
...
aqua-helm/server                    6.5.11              6.5                 A Helm chart for the Aqua Console components
aqua-helm/enforcer                  6.5.5               6.5                 A Helm chart for the Aqua Enforcer
aqua-helm/kube-enforcer             6.5.5               6.5                 A Helm chart for the Aqua KubeEnforcer
aqua-helm/scanner                   6.5.3               6.5                 A Helm chart for the Aqua Scanner CLI component
aqua-helm/gateway                   6.5.6               6.5                 A Helm chart for the Aqua Gateway
