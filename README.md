...
|---|---|----------------------|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 6.5.18               |
...
aqua-helm/server                6.5.18          6.5             A Helm chart for the Aqua Console components
