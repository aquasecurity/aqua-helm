...
|---|---|----------------------|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 2022.4.7|
...
aqua-helm/server                2022.4.7        2022.4          A Helm chart for the Aqua Console components
