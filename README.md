...
|-|-|-|
| [Server](server/) | Deploys the Console, Database, and Gateway components; optionally deploys Envoy component | 6.0.6 |
| [Enforcer](enforcer/) | Deploys the Aqua Enforcer daemonset | 6.0.5 |
| [Scanner](scanner/)  | Deploys the Aqua Scanner deployment | 6.0.5 |
| [KubeEnforcer](kube-enforcer/)| Deploys the Aqua KubeEnforcer | 6.0.5 |
| [Gateway](gateway)| Deploys the Aqua Standalone Gateway | 6.0.3 |
...
aqua-helm/server          6.0.6               6.0                 A Helm chart for the Aqua Console components
aqua-helm/kube-enforcer   6.0.5               6.0                 A Helm chart for the Aqua KubeEnforcer
aqua-helm/gateway         6.0.3               6.0                 A Helm chart for the Aqua Gateway
